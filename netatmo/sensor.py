...
class NetatmoOpeningSirenSensor(NetatmoModuleEntity, SensorEntity):
    """Implementation of a Netatmo sensor."""
...
class NetatmoOpeningSensor(NetatmoOpeningSirenSensor):
    """Implementation of a Netatmo binary sensor."""


class NetatmoSirenSensor(NetatmoOpeningSirenSensor):
    """Implementation of a Netatmo binary sensor."""
